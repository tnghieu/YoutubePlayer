...
public class YoutubeActivity extends YouTubeBaseActivity
    ...
    private final static String TAG = "YoutubePlayer";
    static final String GOOGLE_API_KEY = "AIzaSyDdBHBrgI6q9HpGPxWTZosRRKWfPiKn-G8";
    static final String YOUTUBE_VIDEO_ID = "6w6pEXZutoY";
    ...
    private YouTubePlayer.PlaybackEventListener playbackEventListener = new YouTubePlayer.PlaybackEventListener() {
        ...
        public void onSeekTo(int i) {
            Toast.makeText(YoutubeActivity.this, "Video is seeking", Toast.LENGTH_LONG).show();
        }
    };
    ...
    private YouTubePlayer.PlayerStateChangeListener playerStateChangeListener = new YouTubePlayer.PlayerStateChangeListener() {
        ...
        public void onAdStarted() {
            Toast.makeText(YoutubeActivity.this, "Click ad now to make creator rich", Toast.LENGTH_LONG).show();
        }
